                      ...
                      <div className="d-sm-flex align-items-center justify-content-between row-gap-3">
                        <div className="d-flex align-items-center overflow-hidden mb-3">
                          <div className="avatar avatar-xxl rounded flex-shrink-0 border border-2 border-white me-3">
                            <img
                              src="https://static.skillshare.com/uploads/users/6431731/user-image-medium.jpg?259933190"
                              alt="Img"
                            />
                          </div>
                  ...
                  >
                    <div className="item">
                      <div className="bg-light-400 rounded p-3">
                        ...
                        <p className="text-dark">CS, Batch B</p>
                      </div>
                    </div>
                    <div className="item">
                      <div className="bg-light-400 rounded p-3">
                        ...
                        <p className="text-dark">CS, Batch C</p>
                      </div>
                    </div>
                    <div className="item">
                      <div className="bg-light-400 rounded p-3">
                        ...
                        <p className="text-dark">CS, Batch A</p>
                      </div>
                    </div>
                    <div className="item">
                      <div className="bg-light-400 rounded p-3">
                        ...
                        <p className="text-dark">CS, Batch D</p>
                      </div>
                    </div>
                    <div className="item">
                      <div className="bg-light-400 rounded p-3">
                        ...
                        <p className="text-dark">CS, Batch E</p>
                      </div>
                    </div>
                  </Slider>
                </div>
                    ...
                    <div className="card-body pb-0">
                      <div className="bg-light-300 rounde border p-3 mb-3">
                        <div className="d-flex align-items-center justify-content-between flex-wrap">
                          ...
                          <p className="mb-2">14 May 2025 - 21 May 2025</p>
                        </div>
                              ...
                              <div className="avatar-list-stacked avatar-group-xs d-flex">
                                <span className="avatar avatar-rounded">
                                  <img
                                    ...
                                    src="https://tse3.mm.bing.net/th?id=OIP.XH4YcNfADP9RuJO4w2emfQHaE6&pid=Api&P=0&h=180"
                                    alt="img"
                                  />
                                </span>
                                <span className="avatar avatar-rounded">
                    ...
                    <div className="card-body">
                      ...
                      <div className="d-flex align-items-center justify-content-between p-3 mb-2 border br-5">
                        <div className="d-flex align-items-center overflow-hidden me-2">
                          ...
                          >
                            <img
                              src="https://tse3.mm.bing.net/th?id=OIP.md8Mbq1mfJuzB8zDSRIUEAHaJ4&pid=Api&P=0&h=180"
                              alt="student"
                            />
                          </Link>
                          <div className="overflow-hidden">
                      ...
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <div className="avatar-list-stacked avatar-group-sm">
                          <span className="avatar border-0">
                            <img
                              src="https://www.bayleybulletin.com/wp-content/uploads/2016/08/Ashlynn-Fayth-Smith-900.jpg"
