          ...
          <div className="d-md-flex d-block align-items-center justify-content-between mb-3">
            ...
            <div className="dash-select-student d-flex align-items-center mb-2">
              ...
              <div className="student-active d-flex align-items-center ms-2">
                ...
                >
                  <img
                    src="https://i1.rgstatic.net/ii/profile.image/11431281215205874-1704071975882_Q512/Andrew-Parker-40.jpg"
                    alt="Profile"
                  />
                </Link>
                <Link
                ...
                >
                  <img
                    src="https://s3.amazonaws.com/shecodesio-production/students/avatars/000/212/301/medium/1000132771.jpg?1727726584"
                    alt="Profile"
                  />
                </Link>
              </div>
                ...
                <div className="card-body">
                  <div className="d-flex align-items-center row-gap-3">
                    <div className="avatar avatar-xxl rounded flex-shrink-0 me-3">
                      <img
                        src="https://i1.rgstatic.net/ii/profile.image/11431281277856137-1726276537324_Q512/Sahar-Abdalghny.jpg"
                        alt="Img"
                      />
                    </div>
                    ...
                    <li className="list-group-item p-3">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          ...
                          >
                            <img
                              src="https://tse2.mm.bing.net/th?id=OIP.QVbJLMZz9ngUGDeE83fBYAHaFi&pid=Api&P=0&h=180"
                              className="img-fluid"
                              alt="img"
                            />
                          </Link>
                    ...
                    <li className="list-group-item p-3">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          ...
                          >
                            <img
                              src="https://newjerseycraftbeer.com/wp-content/uploads/2018/05/simple-unique-farewell-party-illustration-various-purposes-best-use-farewell-party-illustration-vector-art-logo-106482289.jpg"
                              className="img-fluid"
                              alt="img"
                            />
                          </Link>
                    ...
                    <li className="list-group-item p-3">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          ...
                          >
                            <img
                              src="https://tse4.mm.bing.net/th?id=OIP.VhJ59yEDHHlGYYXpyTnV6AHaE8&pid=Api&P=0&h=180"
                              className="img-fluid"
                              alt="img"
                            />
                          </Link>
                    ...
                    <li className="list-group-item p-3">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className="d-flex align-items-center">
                          ...
                          >
                            <img
                              src="https://i1.wp.com/www.hepi.ac.uk/wp-content/uploads/2020/03/iStock-539292283-scaled.jpg?fit=2560%2C1810&ssl=1"
                              className="img-fluid"
                              alt="img"
                            />
                          </Link>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              >
                               <img
                                  src="https://tse1.mm.bing.net/th?id=OIP.JtOrgieD2K1Ho_2LjZnaUAHaH4&pid=Api&P=0&h=180"
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              >
                                <img
                                  src="https://tse1.mm.bing.net/th?id=OIP.ovWmL6Q9mEejwAwbIdWbHQHaE8&pid=Api&P=0&h=180"
                                  className="img-fluid rounded-circle"
                                  alt="img"
                                />
                              </Link>
                        ...
                        <tr>
                          ...
                          <td>
                            <div className="d-flex align-items-center">
                              ...
                              >
                                <img
                                  src="https://tse4.mm.bing.net/th?id=OIP.Cy0GMcj8IxS1U0mKlIPeYwHaHk&pid=Api&P=0&h=180"
                                  className="img-fluid rounded-circle"
                                  alt="img"
                                />
                              </Link>
