...
const EditStudent = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(`${api_path}/students/getStudentById?rollNo=${rollNo}`,
      { method: "GET" });
      if (!response.ok) {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${api_path}/students/updateStudent`, {
        method: "PUT",
                      ...
                      <div className="col-md-12">
                        <div className="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                          ...
                          <div className="profile-upload">
                            ...
                            <p className="fs-12">
                              Upload image size 2MB, Format JPG, PNG, SVG
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="row row-cols-xxl-5 row-cols-md-6">
                      ...
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
                          ...
                          <input type="text" id="rollNumber" name="rollNumber" className="form-control" value={studentData.rollNumber} onChange={handleChange} readOnly/>
                        </div>
                      </div>
                      <div className="col-xxl col-xl-3 col-md-6">
                        <div className="mb-3">
