            ...
            <div className="card-body">
              ...
              <div className="d-flex align-items-center justify-content-between gx-2">
                ...
                <div>
                  ...
                  <p className="text-dark">10 Jan 2024</p>
                </div>
              </div>
            </div>
          ...
          <div className="card flex-fill">
            ...
            <div className="card-body">
              ...
              <div className="d-flex align-items-center justify-content-between gx-2">
                ...
                <div>
                  <p className="mb-0">Joined On</p>
                  <p className="text-dark">19 Aug 2024</p>
                </div>
              </div>
            </div>
            <div className="card-footer d-flex align-items-center justify-content-between">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <ImageWithBasePath
                      src="assets/img/students/stu-1.jpg"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
              ...
              <div className="d-flex align-items-center justify-content-between gx-2">
                ...
                <div>
                  <p className="mb-0">Joined On</p>
                  <p className="text-dark">5 Dec 2023</p>
                </div>
              </div>
            </div>
            <div className="card-footer d-flex align-items-center justify-content-between">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <ImageWithBasePath
                      src="assets/img/students/stu-5.jpg"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
              ...
              <div className="d-flex align-items-center justify-content-between gx-2">
                ...
                <div>
                  <p className="mb-0">Joined On</p>
                  <p className="text-dark">13 May 2024</p>
                </div>
              </div>
            </div>
            <div className="card-footer d-flex align-items-center justify-content-between">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <ImageWithBasePath
                      src="assets/img/students/stu-4.jpg"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
              ...
              <div className="d-flex align-items-center justify-content-between gx-2">
                ...
                <div>
                  <p className="mb-0">Joined On</p>
                  <p className="text-dark">20 Jun 2024</p>
                </div>
              </div>
            </div>
            <div className="card-footer d-flex align-items-center justify-content-between">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <ImageWithBasePath
                      src="assets/img/students/stu-6.jpg"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/free-photo/responsible-student_23-2147650755.jpg?size=626&ext=jpg&uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/free-psd/expressive-woman-gesturing_23-2150198673.jpg?size=626&ext=jpg&uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
              ...
              <div className="d-flex align-items-center justify-content-between gx-2">
                ...
                <div>
                  <p className="mb-0">Joined On</p>
                  <p className="text-dark">26 May 2022</p>
                </div>
              </div>
            </div>
            <div className="card-footer d-flex align-items-center justify-content-between">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/free-photo/business-man-curly-cute-handsome-guy-black-suit-close-up-smiling_140725-162638.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/premium-photo/latin-student-smiling-university-uniform-campus-daylight-generative-ai_437323-25414.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/free-photo/young-attractive-teenage-girl-wearing-striped-casual-t-shirt-posing-against-pink-wall-with-charming-smile-looks-happy_176532-10915.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/premium-photo/man-with-glasses-blue-shirt-with-white-shirt-that-says-he-is-wearing-blue-shirt-quo_847607-14855.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
              ...
              <div className="d-flex align-items-center justify-content-between gx-2">
                ...
                <div>
                  <p className="mb-0">Joined On</p>
                  <p className="text-dark">11 Aug 2024</p>
                </div>
              </div>
            </div>
            <div className="card-footer d-flex align-items-center justify-content-between">
