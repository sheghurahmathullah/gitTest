                      ...
                      <div className="d-flex flex-nowrap overflow-auto">
                        <div className="d-flex flex-column me-4 flex-fill">
                          ...
                          <div className="bg-transparent-danger rounded p-3 mb-4">
                            ...
                            <p className="text-dark">Subject : Comp Sci</p>
                            <div className="bg-white rounded p-1 mt-3">
                              ...
                              >
                                <span className="avatar avatar-sm me-2">
                                  <img
                                    src="https://tse3.mm.bing.net/th?id=OIP.GKmvne7gYMfpLR1yuFpaMQHaJQ&pid=Api&P=0&h=180"
                                    alt="Img"
                                  />
                                </span>
                                Jacquelin
                          ...
                          <div className="bg-transparent-primary rounded p-3 mb-4">
                            ...
                            <p className="text-dark">Subject : Networking</p>
                            <div className="bg-white rounded p-1 mt-3">
                              <Link
                                to={routes.teacherDetails}
                                className="text-muted d-flex align-items-center"
                          ...
                          <div className="bg-transparent-success rounded p-3 mb-4">
                            ...
                            <p className="text-dark">Subject :Python </p>
                            <div className="bg-white rounded p-1 mt-3">
                              <Link
                                to={routes.teacherDetails}
                                className="text-muted d-flex align-items-center"
                              >
                                <span className="avatar avatar-sm me-2">
                                  <img
                                    src="https://tse4.mm.bing.net/th?id=OIP._DoNf2ZJ8c3ou6zjD2quRgHaHa&pid=Api&P=0&h=180"
                                    alt="Img"
                                  />
                                </span>
                                Daniel
                          ...
                          <div className="bg-transparent-pending rounded p-3 mb-4">
                            ...
                            <p className="text-dark">Subject : DSA</p>
                            <div className="bg-white rounded p-1 mt-3">
                              <Link
                                to={routes.teacherDetails}
                                className="text-muted d-flex align-items-center"
                              >
                                <span className="avatar avatar-sm me-2">
                                  <img
                                    src="https://tse2.mm.bing.net/th?id=OIP.asci5mjFRAKPaI5bktP8JwHaJQ&pid=Api&P=0&h=180"
                                    alt="Img"
                                  />
                                </span>
                                Erickson
                          ...
                          <div className="bg-transparent-info rounded p-3 mb-4">
                            ...
                            <p className="text-dark">Subject : OOPS </p>
                            <div className="bg-white rounded p-1 mt-3">
                              <Link
                                to={routes.teacherDetails}
                                className="text-muted d-flex align-items-center"
                              >
                                <span className="avatar avatar-sm me-2">
                                  <img
                                    src="https://tse3.mm.bing.net/th?id=OIP.7MHqoISBrcISOnERAYXWJQHaH8&pid=Api&P=0&h=180"
                                    alt="Img"
                                  />
                                </span>
                                Priya
                          ...
                          <div className="bg-transparent-light rounded p-3 mb-4">
                            ...
                            <div className="bg-white rounded p-1 mt-3">
                              ...
                              >
                                <span className="avatar avatar-sm me-2">
                                  <img
                                    src="https://tse2.mm.bing.net/th?id=OIP.l2huD3CyqGiaZVY_0zxhbwHaHa&pid=Api&P=0&h=180"
                                    alt="Img"
                                  />
                                </span>
                                Aaron
                          ...
                          <div className="bg-transparent-warning rounded p-3 mb-4">
                            ...
                            <p className="text-dark">Subject :JAVA</p>
                            <div className="bg-white rounded p-1 mt-3">
                              <Link
                                to={routes.teacherDetails}
                                className="text-muted d-flex align-items-center"
                              >
                                <span className="avatar avatar-sm me-2">
                                  <img
                                    src="https://tse3.mm.bing.net/th?id=OIP.kDL0YJrN5t3jLWVvwFX5rwHaJa&pid=Api&P=0&h=180"
                                    alt="Img"
                                  />
                                </span>
                                Teresa
                        ...
                        <div className="d-flex flex-column me-4 flex-fill">
                          ...
                          <div className="bg-transparent-success rounded p-3 mb-4">
                            ...
                            <p className="text-dark">Subject : C++</p>
                            <div className="bg-white rounded p-1 mt-3">
                              <Link
                                to={routes.teacherDetails}
                                className="text-muted d-flex align-items-center"
