      ...
      <div className="row">
        ...
        <div className="col-xxl-3 col-xl-4 col-md-6 d-flex">
          <div className="card flex-fill">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/free-photo/woman-sitting-table-with-pen_23-2147844852.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
            ...
            <div className="card-footer d-flex align-items-center justify-content-between">
              <span className="badge badge-soft-danger">Comp Sci</span>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/free-photo/international-day-education-celebration_23-2150931024.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link to={routes.teacherDetails}>Daniel</Link>
                    </h6>
                    <p>CS-CS Batch C</p>
                  </div>
                </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/premium-photo/professional-teacher-portrait-ideal-educational-websites-profiles-showcase-expertise_431161-110483.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
        ...
        <div className="col-xxl-3 col-xl-4 col-md-6 d-flex">
          <div className="card flex-fill">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/free-photo/portrait-young-male-professor-education-day_23-2150980043.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link to={routes.teacherDetails}>Erickson</Link>
                    </h6>
                    <p>CS-IT Batch C</p>
                  </div>
                </div>
            ...
            <div className="card-footer d-flex align-items-center justify-content-between">
              <span className="badge badge-soft-danger">Cyber </span>
              <Link to={routes.teacherDetails} className="btn btn-light btn-sm">
                View Details
              </Link>
            </div>
        ...
        <div className="col-xxl-3 col-xl-4 col-md-6 d-flex">
          <div className="card flex-fill">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/free-photo/confident-male-teacher-wearing-glasses-sitting-table-with-school-tools-classroom_141793-114409.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
            ...
            <div className="card-footer d-flex align-items-center justify-content-between">
              <span className="badge badge-soft-danger">Cloud</span>
              <Link to={routes.teacherDetails} className="btn btn-light btn-sm">
                View Details
              </Link>
            </div>
        ...
        <div className="col-xxl-3 col-xl-4 col-md-6 d-flex">
          <div className="card flex-fill">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/premium-photo/portrait-confident-indian-teacher-standing-front-black-board-class-room_1208970-64404.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
            ...
            <div className="card-footer d-flex align-items-center justify-content-between">
              <span className="badge badge-soft-danger">Networking</span>
              <Link to={routes.teacherDetails} className="btn btn-light btn-sm">
                View Details
              </Link>
            </div>
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/premium-photo/confident-young-indian-woman-smiling-classroom-office_875825-49977.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
        ...
        <div className="col-xxl-3 col-xl-4 col-md-6 d-flex">
          <div className="card flex-fill">
            ...
            <div className="card-body">
              <div className="bg-light-300 rounded-2 p-3 mb-3">
                <div className="d-flex align-items-center">
                  ...
                  >
                    <img
                      src="https://img.freepik.com/premium-photo/casual-young-man-shirt_146377-212.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                      className="img-fluid rounded-circle"
                      alt="img"
                    />
                  </Link>
                  <div className="ms-2">
                    <h6 className="text-dark text-truncate mb-0">
                      <Link to={routes.teacherDetails}>Raul</Link>
                    </h6>
                    <p>IV</p>
                  </div>
                </div>
            ...
            <div className="card-footer d-flex align-items-center justify-content-between">
              <span className="badge badge-soft-danger">Coding</span>
              <Link to={routes.teacherDetails} className="btn btn-light btn-sm">
                View Details
              </Link>
            </div>
