                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://tse3.mm.bing.net/th?id=OIP.63BsbR0xiN5ii_h7FR6UZwHaHa&pid=Api&P=0&h=180"
                          alt="img"
                          className="img-fluid rounded-circle"
                        />
                      </Link>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://tse1.mm.bing.net/th?id=OIP.vwkMblj6raRW518gF0yKwgHaHa&pid=Api&P=0&h=180"
                          className="img-fluid rounded-circle"
                          alt="img"
                        />
                      </Link>
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://img.freepik.com/free-photo/young-woman-wearing-striped-shirt-eyeglasses_273609-13230.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                          alt="img"
                          className="img-fluid rounded-circle"
                        />
                      </Link>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://img.freepik.com/free-photo/young-girl-with-short-hair-wearing-polo-shirt-looking-camera-with-smile-face_141793-46444.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                          className="img-fluid rounded-circle"
                          alt="img"
                        />
                      </Link>
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://img.freepik.com/premium-photo/young-indian-student-standing-front-university-campus_1239886-2374.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                          alt="img"
                          className="img-fluid rounded-circle"
                        />
                      </Link>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://img.freepik.com/free-photo/horizontal-portrait-smiling-happy-young-pleasant-looking-female-wears-denim-shirt-stylish-glasses-with-straight-blonde-hair-expresses-positiveness-poses_176420-13176.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                          className="img-fluid rounded-circle"
                          alt="img"
                        />
                      </Link>
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://img.freepik.com/premium-photo/young-beautiful-student-picture_216014-17133.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                          alt="img"
                          className="img-fluid rounded-circle"
                        />
                      </Link>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://img.freepik.com/free-photo/portrait-young-girl-smiling_23-2149260597.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                          className="img-fluid rounded-circle"
                          alt="img"
                        />
                      </Link>
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://img.freepik.com/premium-photo/portrait-female-college-student-park_573056-8426.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                          alt="img"
                          className="img-fluid rounded-circle"
                        />
                      </Link>
                ...
                <div className="card-body">
                  <div className="bg-light-300 rounded-2 p-3 mb-3">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                          className="img-fluid rounded-circle"
                          alt="img"
                        />
                      </Link>
                ...
                <div className="card-footer d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    <div className="d-flex align-items-center">
                      ...
                      >
                        <img
                          src="https://img.freepik.com/free-photo/close-up-beautiful-woman-smiling_23-2148369437.jpg?uid=P158678429&ga=GA1.1.1440782937.1705666628&semt=ais_hybrid"
                          alt="img"
                          className="img-fluid rounded-circle"
                        />
                      </Link>
